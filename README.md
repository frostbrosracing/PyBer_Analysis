...
The analysis was conducted by grouping cities according to what type of city they were.  These types were: ***urban***, ***suburban***, and ***rural***.  By classifying cities in this way, new trends begin to emerge in the data collected based on a number of factors.  
...
The results show that between the ***urban*** and ***rural*** city types, there's a great disparity in the summarized values for each of the figures being calculated, and will therefore be the focus of this analysis.  The image below shows the totals and averages for all calculated summaries.
